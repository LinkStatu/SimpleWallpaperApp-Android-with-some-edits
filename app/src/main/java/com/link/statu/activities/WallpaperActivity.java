...
import com.link.statu.utils.ApplyWallpaper;
import com.link.statu.utils.FastBlurTransform;
...
//        saving
        processStart(getString(R.string.success_downloaded));
...
//        delay of 500ms
        new Handler(Looper.getMainLooper()).postDelayed(() -> {
            if (isSaved) {
                ...
                message = getString(R.string.error_download);
                processStopIfDone();
            }
        }, 500);
        ...
        executor.execute(() -> {
            ...
            handler.post(() -> {
                if (b) {
                    ...
                    message = getString(R.string.error_applied);
                    processStopIfDone();
                }
            });
        });
