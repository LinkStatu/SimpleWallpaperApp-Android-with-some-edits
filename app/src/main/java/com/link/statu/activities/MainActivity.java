package com.link.statu.activities;
...
import com.link.statu.fragments.CategoryFragment;
import com.link.statu.fragments.WallsFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.findItem(R.id.btnMoreApps).setOnMenuItemClickListener(menuItem -> {
            Intent i = new Intent(Intent.ACTION_VIEW);
            i.setData(Uri.parse(getString(R.string.simi_app_link)));
            startActivity(i);
            return true;
        });

        menu.findItem(R.id.action_rate_us).setOnMenuItemClickListener(menuItem -> {
            Intent i = new Intent(Intent.ACTION_VIEW);
            i.setData(Uri.parse(getString(R.string.rate_us_link)));
            startActivity(i);
            return true;
        });
        ...
        switch (currentFragPos){
            case 0:
                searchView.setQueryHint(getString(R.string.search_wallpaper));
            break;
            case 1:
